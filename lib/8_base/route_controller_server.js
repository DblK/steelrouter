...
/* Imports */
/*****************************************************************************/
var AsyncHooks = Npm.require('node:async_hooks');
var Controller = Iron.Controller;
var Url = Iron.Url;
var MiddlewareStack = Iron.MiddlewareStack;
var debug = Iron.utils.debug('iron:router-controller');
...
RouteController.prototype.dispatch = function (stack, url, done) {
  debug('RouterController.dispatch: start')
  var self = this;
  // const dispatchHooks = AsyncHooks.createHook({
  //   init(asyncId, type, triggerAsyncId) {
  //     console.log('AsyncId: ' + asyncId + ', type: ' + type + ', triggerAsyncId: '+triggerAsyncId);
  //     stack.dispatch(url, self, done);  
  //   }
  // })
  // dispatchHooks.enable();
